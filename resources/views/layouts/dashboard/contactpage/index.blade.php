...
<div class=" col-lg-12 page-titles">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">View Contact Page Info</a></li>
    </ol>
</div>
{{-- pages tittle part --}}
                        ...
                        <thead>
                            <tr role="row">
                                <th class="sorting_asc" tabindex="0" aria-controls="example3" rowspan="1" colspan="1"
                                    ...
                                    style="width: 25px;">Contact Photo</th>
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                <td class="sorting_1"><img class="-" width="80"
                                        src="{{ asset('uploads/contact_photo') }}/{{  $info->contact_photo }} " alt=""></td>
                                <td><a href="javascript:void(0);"><strong>{{ $info->description }}</strong></a></td>
                                <td>{{ $info->created_at }}</td>
                                <td>{{ $info->updated_at }}</td>
                                <td>
                                    <div class="d-flex">
                                        <a href="{{ route('contactpage.edit',$info->id) }}" class="btn btn-primary shadow btn-xs sharp mr-1"><i
                                                class="fa fa-pencil"></i></a>
                                        <form action="{{ route('contactpage.destroy',$info->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
